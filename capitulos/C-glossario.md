...
**Beta (β).** Probabilidade de não detectar um efeito que existe, o erro tipo II.
O poder é 1 menos beta. *Capítulo 6.*

**Bloco permutado.** Técnica de randomização que mantém os grupos com tamanhos
parecidos ao longo do recrutamento. *Capítulo 3.*
...
**Desfecho composto.** Reunião de vários eventos em um único desfecho.
*Capítulo 4.*

**Desfecho primário.** O desfecho que define a conclusão do estudo e o cálculo do
tamanho da amostra. É um só. *Capítulo 4.*

**Desfecho substituto.** Desfecho medido no lugar do que interessa, por ser mais
rápido ou fácil. *Capítulo 4.*

**Desvio padrão.** Medida de dispersão dos dados em torno da média. Descreve os
participantes. *Capítulo 8.*

**Dicotomizar.** Transformar variável contínua em duas categorias. Perde
informação e poder. *Capítulo 4.*
...
**Hipótese nula.** A hipótese de ausência de efeito, que o teste estatístico
supõe verdadeira para calcular o valor de p. *Capítulo 10.*

## I

**Intervalo de confiança.** Faixa de valores compatíveis com os dados observados.
Sua largura mede a incerteza que restou. *Capítulo 9.*

**Intervalo interquartil.** Distância entre o primeiro e o terceiro quartil.
Acompanha a mediana. *Capítulo 8.*

## K

**Kaplan-Meier.** Método de estimar a curva de tempo até o evento na presença de
censura. *Capítulo 14.*

## L

**Log-rank.** Teste que compara duas ou mais curvas de sobrevida. *Capítulo 14.*
...
**Qui-quadrado.** Teste que compara frequências observadas com as esperadas sob a
hipótese de ausência de associação. *Capítulo 10.*
