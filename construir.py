...
def construir():
    ...
    capa = (
        ...
        + texto_capa +
        '<div class="ficha">'
        f'<p class="autor-ficha">Copyright © {html.escape(livro["autor"])}</p>'
        '<p class="perfis">'
        ...
        "</p>"
        f'<p>ISBN: {html.escape(livro["isbn"])} · Licença '
        f'<a href="{livro["licenca_url"]}" target="_blank" rel="license noopener">'
        f'{html.escape(livro["licenca"])}</a></p>'
